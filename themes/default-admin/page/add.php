...
<div class="container">
	<div class="context">
		...
		<form class="form-horizontal" name="add" onSubmit="return add_validate()" method="post">
			<input type="hidden" name="command" />

			<div class="control-group">
				<label class="control-label" for="page_name">Page Title</label>
				<div class="controls"><input type="text" id="page_name" name="page_name" value="<?php echo $_REQUEST['page_name']; ?>" /></div>
			</div>

			<div class="control-group">
				<label class="control-label" for="page_description">Page Description</label>
				<div class="controls">
					<textarea id="page_description" style="width:50%; height:5%;" name="page_description" ><?php echo $_REQUEST['page_description']; ?></textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea id="page_keywords" style="width:50%; height:5%;" name="page_keywords"><?php echo $_REQUEST['page_keywords']; ?></textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="page_text" id="page_text"><?php echo $_REQUEST['page_text']; ?></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="radio inline">
						<input type="radio" id="publish" name="page_status" value="publish" <?php if( $_request['page_status'] == 'publish' ){ ?>checked="checked"<?php } ?> />
						Publish
					</label>
					<label class="radio inline">
						<input type="radio" id="draft" name="page_status" value="draft" <?php if( $_request['page_status'] == 'draft' ){ ?>checked="checked"<?php }else{ ?>checked="checked"<?php } ?> />
						Draft
					</label>
				</div>
			</div>
			...
			<div class="control-group">
				<div class="controls">
					<input type="submit" class="btn btn-primary btn-large" name="submit" value="Add Page" />
				</div>
			</div>
