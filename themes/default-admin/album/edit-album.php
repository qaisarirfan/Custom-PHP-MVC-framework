...
<div class="container">
	<div class="context">
		...
		<form class="form-horizontal" name="edit" onSubmit="return edit_allbum_validate()" method="post">
			...
			<div class="control-group">
				...
				<div class="controls"><input id="album_name" type="text" name="album_name" value="<?php echo stripslashes( $this->row['album_name'] ); ?>" /></div>
			</div>

			<div class="control-group">
				<label class="control-label" for="album_description">Description</label>
				<div class="controls">
					<textarea id="album_description" class="textarea" name="album_description" style="width:50%; height:5%;"><?php echo stripslashes( $this->row['album_description'] ); ?></textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea id="album_keywords" class="textarea" style="width:50%; height:5%;" name="album_keywords"><?php echo stripslashes( $this->row['album_keywords'] ); ?></textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea id="album_detail" name="album_detail"><?php echo stripslashes( $this->row['album_detail'] ); ?></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="radio inline">
						<input type="radio" id="publish" name="album_status" value="publish"<?php if ( $this->row['album_status'] == 'publish' ){ ?> checked="checked" <?php } ?> />
						Publish
					</label>
					<label class="radio inline">
						<input type="radio" id="draft" name="album_status" value="draft" <?php if ( $this->row['album_status'] == 'draft' ){ ?> checked="checked" <?php } ?> />
						Draft
					</label>
				</div>
			</div>
			...
			<div class="control-group">
				<div class="controls">
					<input type="submit" class="btn btn-primary" name="submit" value="Save Album" />
				</div>
			</div>
		</form>
	</div>
...
<script type="text/javascript" language="javascript">
	document.edit.category.value = '<?php echo $this->row['category']; ?>';
	document.edit.sub_category.value = '<?php echo $this->row['sub_category'] ?>';
</script>
</body>
</html>