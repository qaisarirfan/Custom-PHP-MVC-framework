...
<div class="container">
	<div class="context">
		...
		<form class="form-horizontal" name="add_images" onSubmit="return add_images_validate()" enctype="multipart/form-data" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<span class="help-inline">Valid size is <span id="valid-size"></span> KB <span id="size">&nbsp;</span></span>
				</div>
			</div>

			<div class="control-group">
				<label class="control-label" for="photo_title">Image Title :</label>
				<div class="controls"> <input id="photo_title" type="text" name="photo_title" /> </div>
			</div>

			<div class="control-group">
				<label class="control-label" for="photo_reference">Image Reference :</label>
				<div class="controls"> <textarea id="photo_reference" name="photo_reference" style="width:50%; height:5%;" ></textarea> </div>
			</div>
			...
			<div class="control-group">
				<div class="controls">
					<input type="submit" class="btn btn-primary" name="submit" value="Add Photo" />
				</div>
			</div>
